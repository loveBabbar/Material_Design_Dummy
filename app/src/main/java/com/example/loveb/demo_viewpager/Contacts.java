...
public class Contacts extends Fragment {
    ...
    private String[] matter={"one","two","three","four","five","six","seven","eight","nine","ten"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter arrayAdapter=new ArrayAdapter(getContext(),android.R.layout.simple_list_item_1,matter);
